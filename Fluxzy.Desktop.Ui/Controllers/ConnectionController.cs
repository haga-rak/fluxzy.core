...
namespace Fluxzy.Desktop.Ui.Controllers
{
    ...
    public class ConnectionController
    {
        ...
        public async Task<ActionResult<bool>> HasDump(
            int connectionId, [FromServices] IArchiveReaderProvider archiveReaderProvider)
        {
        ...
        public async Task<ActionResult<bool>> SaveCapture(
            int connectionId,
            [FromServices]
            SaveRawCaptureAction saveRawCaptureAction, [FromBody] SaveFileViewModel body,
            [FromServices]
        ...
        public async Task<ActionResult<bool>> OpenCapture(
            int connectionId,
            [FromServices]
            FileExecutionManager fileExecutionManager,
            [FromServices]
            ProxyControl proxyControl, [FromQuery] bool withKey = false)
        {
            var archiveReader = await _archiveReaderObservable.FirstAsync();
            proxyControl.TryFlush();
        ...
        public async Task<ActionResult<string?>> GetCaptureKey(
            int connectionId,
            [FromServices]
            FileExecutionManager fileExecutionManager,
            [FromServices]
