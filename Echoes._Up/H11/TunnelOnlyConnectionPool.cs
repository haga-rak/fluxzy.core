    ...
    public class TunnelOnlyConnectionPool : IHttpConnectionPool
    {
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                using (var ex = new TunneledConnectionProcess(Authority, _timingProvider, _connectionBuilder, _globalSetting))
                {
