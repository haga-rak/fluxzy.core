...
namespace Fluxzy.Rules.Filters
{
    ...
    ///     - OnAuthorityReceived : The moment when fluxzy knows the destination authority. It will occur the moment where
    ///     fluxzy parsed
    ///     CONNECT request in a regular proxy communication
